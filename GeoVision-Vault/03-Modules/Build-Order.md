...
| 12 | ◑ **spine done** | 2026-08-15 | | Auth, `/me`, create project, the folder workspace, the pairing modal, and the `useRealtime` hook deferred from 14. 45 frontend tests. Remaining: devices/members pages, invitations, notifications, profile editing, asset upload, report modal, lightbox. |
| 13 | planned | | | |
